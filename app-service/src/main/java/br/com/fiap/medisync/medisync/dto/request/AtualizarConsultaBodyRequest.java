...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "DTO para atualização de um nova Consulta")
@SchemaMapping("AtualizarConsultaBodyRequest")
public class AtualizarConsultaBodyRequest {
    ...
    @NotBlank(message = "O status da Consulta é obrigatória")
    @Schema(description = "Status da Consulta", example = "REALIZADA", requiredMode = Schema.RequiredMode.REQUIRED)
